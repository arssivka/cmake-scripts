...
#
#set(HUI "")
#target_architecture(HUI)
#message(WARNING "hui " ${HUI})
...
if(EXISTS "${VREP_ROOT}/programming/include" AND EXISTS "${VREP_ROOT}/programming/common" AND EXISTS "${VREP_ROOT}/programming/remoteApi")
    set(VREP_INCLUDE "${VREP_ROOT}/programming/include")
    set(VREP_COMMON "${VREP_ROOT}/programming/common")
    set(VREP_REMOTE "${VREP_ROOT}/programming/remoteApi")
...
elseif(UNIX AND NOT APPLE)
    ...
    set(VREP_LIBRARIES ${VREP_ROOT}/libv_repExtRemoteApi.so) #${VREP_ROOT}/libv_rep.so
elseif(UNIX AND APPLE)
    ...
    set(VREP_LIBRARIES ${VREP_ROOT}/libv_repExtRemoteApi.so)
endif()
